...
[`JobMonitorUrls`](https://cj-mills.github.io/cjm-fasthtml-job-monitor/models.html#jobmonitorurls)
...
placeholder at page level 4. Add
[`get_sse_headers()`](https://cj-mills.github.io/cjm-fasthtml-job-monitor/components/modal.html#get_sse_headers)
to their app’s header list (after HTMX) 5. Provide callbacks for job
lifecycle events 6. `job_args_builder` returns
`List[Tuple[tuple, dict]]` (list of `(args, kwargs)` pairs)

------------------------------------------------------------------------

<a
href="https://github.com/cj-mills/cjm-fasthtml-job-monitor/blob/main/cjm_fasthtml_job_monitor/routes/init.py#L66"
...
<a
href="https://github.com/cj-mills/cjm-fasthtml-job-monitor/blob/main/cjm_fasthtml_job_monitor/routes/init.py#L387"
target="_blank" style="float:right; font-size:smaller">source</a>
